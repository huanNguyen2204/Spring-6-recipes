...
public class AtomFeedView extends AbstractAtomFeedView {
    ...
    @Override
    protected void buildFeedMetadata(Map<String, Object> model, Feed feed, HttpServletRequest) {
    ...
    private Entry toEntry(TournamentContent tc) {
        var sumary = new Content();
        sumary.setValue(String.format("%s - %s", tc.name(), tc.link()));
